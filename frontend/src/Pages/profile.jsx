...
export default function Profile() {
  ...
  return (
    <>
      <Navbar />
      <div className="w-10/12 lg:w-[900px] bg-primary pt-20 mx-auto mt-10 rounded-xl relative px-8 pb-10 mt-20">
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          ...
          <div className="flex flex-col justify-center items-center gap-5">
            ...
            <Button type="primary" className="bg-secondary" onClick={SavingOn}>
              Save
            </Button>
          </div>
        </div>
